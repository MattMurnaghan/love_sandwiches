"""
This is a program to calculate the surplus sales data from the sandwiches sold
at a shop and update a google sheet with this data
"""
import gspread
...
def validate_data(values):
    ...
    Raises ValueError if the strings canont be converted into int,
